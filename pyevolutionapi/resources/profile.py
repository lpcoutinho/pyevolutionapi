...
class ProfileResource(BaseResource):
    ...
    def fetch_business_profile(self, instance: str, number: str) -> Dict[str, Any]:
        ...
        """
        return self._post(
            f"/chat/fetchBusinessProfile/{instance}",
            json={"number": number}
        )
    ...
    def update_name(self, instance: str, name: str) -> Dict[str, Any]:
        ...
        """
        return self._post(
            f"/chat/updateProfileName/{instance}",
            json={"name": name}
        )
    ...
    def update_status(self, instance: str, status: str) -> Dict[str, Any]:
        ...
        """
        return self._post(
            f"/chat/updateProfileStatus/{instance}",
            json={"status": status}
        )
    ...
    def update_picture(self, instance: str, picture: str) -> Dict[str, Any]:
        ...
        """
        return self._post(
            f"/chat/updateProfilePicture/{instance}",
    ...
    def update_privacy_settings(
        ...
        """
        return self._post(
            f"/chat/updatePrivacySettings/{instance}",
            json=settings
        )