...
from ..models.group import Group, GroupCreate, GroupResponse, ParticipantUpdate
...
class GroupResource(BaseResource):
    ...
    def create(
        ...
        response_data = self._post(
            f"/group/create/{instance}",
            json=group_data.dict_for_api()
        )
    ...
    def revoke_invite_code(self, instance: str, group_jid: str) -> Dict[str, Any]:
        ...
        """
        return self._post(
            f"/group/revokeInviteCode/{instance}",
            params={"groupJid": group_jid}
        )
