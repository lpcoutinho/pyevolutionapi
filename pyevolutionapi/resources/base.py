...
class BaseResource:
    ...
    async def _aget(
        ...
        **kwargs
        ...
        response = await self.client.arequest("GET", endpoint, instance=instance, params=params, **kwargs)
        return response.json()
    ...
    async def _aput(
        ...
        **kwargs
        ...
        response = await self.client.arequest("PUT", endpoint, instance=instance, json=json, **kwargs)
        return response.json()
    ...
    async def _adelete(
        ...
        **kwargs
        ...
        response = await self.client.arequest("DELETE", endpoint, instance=instance, json=json, **kwargs)
        if response.text:
            return response.json()
        return {"status": "success"}